...
import (
	dao "Prove/webook/internal/repository/dao"
	context "context"
	reflect "reflect"
...
// CompleteInfo mocks base method.
func (m *MockUserDAO) CompleteInfo(ctx context.Context, u dao.User) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CompleteInfo", ctx, u)
	ret0, _ := ret[0].(error)
	return ret0
}

// CompleteInfo indicates an expected call of CompleteInfo.
func (mr *MockUserDAOMockRecorder) CompleteInfo(ctx, u interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CompleteInfo", reflect.TypeOf((*MockUserDAO)(nil).CompleteInfo), ctx, u)
}
