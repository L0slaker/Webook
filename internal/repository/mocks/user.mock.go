...
func (m *MockUserRepository) CompleteInfo(ctx context.Context, u *domain.User) error {
	m.ctrl.T.Helper()
...
func (mr *MockUserRepositoryMockRecorder) CompleteInfo(ctx, u interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CompleteInfo", reflect.TypeOf((*MockUserRepository)(nil).CompleteInfo), ctx, u)
}
